//package com.redgifs.network.http
//
...
//                    Timber.e("!!! Network connection error - check internet connection")
//                }
//                is kotlinx.serialization.SerializationException -> {
//                    Timber.e("!!! JSON parsing error - API response format changed?")
//                }
//                is io.ktor.client.plugins.ClientRequestException -> {
//                    Timber.e("!!! HTTP ${e.response.status.value} error")
//                }
