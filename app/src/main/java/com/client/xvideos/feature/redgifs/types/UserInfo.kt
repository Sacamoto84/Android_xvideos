...
data class UserInfo(
    ...
    @SerializedName("followers") val followers: Int = 0,                // * Количество подписчиков пользователя.                      > 68214
    @SerializedName("gifs") val gifs: Int = 0,                     // * Общее количество опубликованных пользователем GIF-файлов. > 439
    @SerializedName("name") val name: String = "",                 // * Имя пользователя.                                         > "lilijunex"
    ...
    @SerializedName("publishedGifs") val publishedGifs: Int = 0,            // * Количество опубликованных публичных GIF-файлов.       > 421 (Отображается в профиле)
    @SerializedName("url") val url: String,                       // * URL-адрес пользователя на сайте ``redgifs.com``. > "https://www.redgifs.com/users/lilijunex"
    @SerializedName("username") val username: String,                  // * Имя пользователя. >"lilijunex"
    @SerializedName("verified") val verified: Boolean = false,         // *
    @SerializedName("views") val views: Int = 0,                    // * Общее количество просмотров всех опубликованных пользователем GIF. > 123194825
)