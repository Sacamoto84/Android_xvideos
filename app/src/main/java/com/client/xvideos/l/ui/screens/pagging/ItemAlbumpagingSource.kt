...
class ItemAlbumpagingSource (val order : Order, val textNiches : String, val redApi: RedApi, val snackBarEvent: SnackBarEvent, val cache : SavedRed_NichesCaches): PagingSource<Int, Niche>() {
