package com.client.xvideos.red.common.block
...
import com.client.xvideos.red.common.block.useCase.blockGetAllBlockedGifs
import com.client.xvideos.red.common.block.useCase.blockGetAllBlockedGifsInfo
...
object BlockRed {
    ...
    fun blockItem(item: GifsInfo) {
        val result = com.client.xvideos.red.common.block.useCase.blockItem(item)
        if (result.isSuccess) {
